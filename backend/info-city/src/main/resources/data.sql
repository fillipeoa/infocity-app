...
INSERT INTO `tbusuario` (`id`, `created_at`, `email`, `foto`, `password`, `updated_at`, `user_name`) VALUES
(1, '2020-12-01', 'admin@localhost', 'teste', '$2a$10$A5c6LmhsiFydP7IKJ3QIcu433x2Ow5Q.Jgw8GmgJ4q1freC/eyOO6', '2020-12-01', 'Marco')
    ON DUPLICATE KEY UPDATE user_name = 'Marco';

INSERT INTO `tbusuario` (`id`, `created_at`, `email`, `foto`, `password`, `updated_at`, `user_name`) VALUES
(2, '2020-12-01', 'admin@localhost', 'teste', '$2a$10$A5c6LmhsiFydP7IKJ3QIcu433x2Ow5Q.Jgw8GmgJ4q1freC/eyOO6', '2020-12-01', 'Fillipe')
